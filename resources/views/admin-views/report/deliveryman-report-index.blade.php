    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{asset('assets/admin/img/icons/order_report.png')}}" alt="{{ translate('order-report') }}">
            ...
            <div class="card-body">
                <div class="media gap-3 flex-column flex-sm-row align-items-sm-center">
                    <div class="avatar avatar-xl avatar-4by3 mr-2">
                        <img class="avatar-img" src="{{asset('assets/admin/svg/illustrations/order.png')}}" alt="{{ translate('image') }}">
                    </div>
