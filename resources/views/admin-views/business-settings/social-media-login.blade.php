...
@section('content')
    <div class="content container-fluid">
        ...
        @if (isset($appleLoginService))
            <div class="card">
                <form action="{{ route('admin.business-settings.update-apple-login-setup') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="client_id" value="{{ $appleLoginService['client_id'] }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{translate('team_id')}}</label>
                                    <input type="text" class="form-control" name="team_id" value="{{ $appleLoginService['team_id'] }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{translate('key_id')}}</label>
                                    <input type="text" class="form-control" name="key_id" value="{{ $appleLoginService['key_id'] }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
