...
@section('title', translate('إنشاء شراء'))
    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                ...
                {{translate('إنشاء شراء جديد')}}
            </h2>
        </div>

        <form action="{{route('admin.purchase.store')}}" method="post" enctype="multipart/form-data" id="purchase-form">
            @csrf
            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input type="number" name="paid_amount" id="paid_amount"
                                                    class="form-control w-100" min="0" step="0.01" value="0"
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_method" class="form-control">
                                            <option value="cash">{{translate('كاش')}}</option>
                                            <option value="bank">{{translate('تحويل بنكي')}}</option>
                                            <option value="check">{{translate('شيك')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="not_entered">{{translate('لم يتم الإدخال للمخزون')}}</option>
                                            <option value="entered">{{translate('تم الإدخال للمخزون')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary">{{translate('حفظ الشراء')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
