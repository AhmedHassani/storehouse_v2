            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer" style="font-family:Arial; color: #333333;">
                ...
                <tr>
                    <td align="left" valign="top" colspan="2" style="border-bottom: 1px solid #CCCCCC; padding-bottom: 10px;">
                        <img alt="" border="0" src="{{url('/').'/storage/restaurant/'.$logo}}" title="" class="sitelogo" width="60%" style="max-width:250px;"/>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top" colspan="2" style="border-bottom: 1px solid #CCCCCC; padding: 20px 0 10px 0;">
                        <span style="font-size: 18px; font-weight: normal;">{{ translate('Email Verification Token') }}</span>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            {{ translate('We have sent you this email in response to your request to verify your email. After you verify email, you will be able to register with your email address.') }}
                            <br/><br/>
                            {{ translate('To verify your email, please use the token below :') }}
