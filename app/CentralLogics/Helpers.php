...
function translate($key)
{
    ...
    if (!array_key_exists($key, $lang_array)) {
        if ($local != 'en' && file_exists(base_path('resources/lang/en/messages.php'))) {
            $en_lang_array = include(base_path('resources/lang/en/messages.php'));
            if (array_key_exists($key, $en_lang_array)) {
                return $en_lang_array[$key];
            }
        }
        ...
        if (!file_exists(base_path('resources/lang/' . $local))) {
            mkdir(base_path('resources/lang/' . $local), 0777, true);
        }
